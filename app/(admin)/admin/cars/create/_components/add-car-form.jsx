...
import { CAR_DEFAULT_VALUES } from "@/constants/defaults";
...
export const AddCarForm = () => {
  ...
  const {
    ...
    defaultValues: CAR_DEFAULT_VALUES,
  });
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <div
                      ...
                      className={`border-2 border-dashed rounded-lg p-6 text-center cursor-pointer hover:opacity-80 transition ${
