...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Vehiclr Auto Group',
    "address" TEXT NOT NULL DEFAULT '401 Industrial Drive, Vehiclr City, CA 90210',
    "phone" TEXT NOT NULL DEFAULT '+1 (800) 555-9090',
    "email" TEXT NOT NULL DEFAULT 'sales@vehiclr.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
